...
export function isVerifiedIssuer(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::zklogin_verified_issuer::VerifiedIssuer`; }
