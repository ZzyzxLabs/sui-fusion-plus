...
export function isObjectTable(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V34}::object_table::ObjectTable` + '<'); }
