...
export function isParty(type: string): boolean {
  ...
  return type === `${PKG_V34}::party::Party`;
}
...
export class Party implements StructClass {
  ...
  static readonly $typeName = `${PKG_V34}::party::Party`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Party.$typeName;
  readonly $fullTypeName: `${typeof PKG_V34}::party::Party`;
  readonly $typeArgs: [];
...
export function isPermissions(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V34}::party::Permissions`;
}
...
export class Permissions implements StructClass {
  ...
  static readonly $typeName = `${PKG_V34}::party::Permissions`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Permissions.$typeName;
  readonly $fullTypeName: `${typeof PKG_V34}::party::Permissions`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PermissionsFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V34}::party::Permissions`;
    this.$typeArgs = typeArgs;
