...
export interface AdminRoleFields<T0 extends PhantomTypeArgument> {
  dummyField: ToField<"bool">;
}

export type AdminRoleReified<T0 extends PhantomTypeArgument> = Reified<
  AdminRole<T0>,
  AdminRoleFields<T0>
>;

export class AdminRole<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::upgrade_service::AdminRole<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    fields: AdminRoleFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      AdminRole.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::upgrade_service::AdminRole<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): AdminRoleReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: AdminRole.$typeName,
      fullTypeName: composeSuiType(
        AdminRole.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::upgrade_service::AdminRole<${PhantomToTypeStr<
      ...
      fromFields: (fields: Record<string, any>) =>
        AdminRole.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AdminRole.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => AdminRole.fromBcs(T0, data),
      bcs: AdminRole.bcs,
      fromJSONField: (field: any) => AdminRole.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => AdminRole.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        AdminRole.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AdminRole.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        AdminRole.fetch(client, T0, id),
      new: (fields: AdminRoleFields<ToPhantomTypeArgument<T0>>) => {
        return new AdminRole([extractType(T0)], fields);
      },
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<AdminRole<ToPhantomTypeArgument<T0>>>> {
    return phantom(AdminRole.reified(T0));
  }
  static get p() {
  ...
  ): AdminRole<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isAdminRole(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a AdminRole object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<AdminRole<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching AdminRole object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAdminRole(res.data.bcs.type)
    ) {
...
export interface AuthorizeUpgradeFields<T0 extends PhantomTypeArgument> {
  packageId: ToField<ID>;
  policy: ToField<"u8">;
}

export type AuthorizeUpgradeReified<T0 extends PhantomTypeArgument> = Reified<
  AuthorizeUpgrade<T0>,
  AuthorizeUpgradeFields<T0>
>;

export class AuthorizeUpgrade<T0 extends PhantomTypeArgument>
  implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::upgrade_service::AuthorizeUpgrade<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: AuthorizeUpgradeFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      AuthorizeUpgrade.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::upgrade_service::AuthorizeUpgrade<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): AuthorizeUpgradeReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: AuthorizeUpgrade.$typeName,
      fullTypeName: composeSuiType(
        AuthorizeUpgrade.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::upgrade_service::AuthorizeUpgrade<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        AuthorizeUpgrade.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AuthorizeUpgrade.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => AuthorizeUpgrade.fromBcs(T0, data),
      bcs: AuthorizeUpgrade.bcs,
      fromJSONField: (field: any) => AuthorizeUpgrade.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        AuthorizeUpgrade.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        AuthorizeUpgrade.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AuthorizeUpgrade.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        AuthorizeUpgrade.fetch(client, T0, id),
      new: (fields: AuthorizeUpgradeFields<ToPhantomTypeArgument<T0>>) => {
        return new AuthorizeUpgrade([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<AuthorizeUpgrade<ToPhantomTypeArgument<T0>>>> {
    return phantom(AuthorizeUpgrade.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): AuthorizeUpgrade<ToPhantomTypeArgument<T0>> {
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return AuthorizeUpgrade.reified(typeArg).new({
      packageId: decodeFromFieldsWithTypes(
        ID.reified(),
        item.fields.package_id
      ),
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return AuthorizeUpgrade.fromFields(
      typeArg,
      AuthorizeUpgrade.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isAuthorizeUpgrade(content.type)) {
      throw new Error(
        ...
        } is not a AuthorizeUpgrade object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        ...
        !isAuthorizeUpgrade(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<AuthorizeUpgrade<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching AuthorizeUpgrade object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAuthorizeUpgrade(res.data.bcs.type)
    ) {
...
export interface CommitUpgradeFields<T0 extends PhantomTypeArgument> {
  packageId: ToField<ID>;
}

export type CommitUpgradeReified<T0 extends PhantomTypeArgument> = Reified<
  CommitUpgrade<T0>,
  CommitUpgradeFields<T0>
>;

export class CommitUpgrade<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::upgrade_service::CommitUpgrade<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: CommitUpgradeFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      CommitUpgrade.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::upgrade_service::CommitUpgrade<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): CommitUpgradeReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: CommitUpgrade.$typeName,
      fullTypeName: composeSuiType(
        CommitUpgrade.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::upgrade_service::CommitUpgrade<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        CommitUpgrade.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        CommitUpgrade.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => CommitUpgrade.fromBcs(T0, data),
      bcs: CommitUpgrade.bcs,
      fromJSONField: (field: any) => CommitUpgrade.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => CommitUpgrade.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        CommitUpgrade.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        CommitUpgrade.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        CommitUpgrade.fetch(client, T0, id),
      new: (fields: CommitUpgradeFields<ToPhantomTypeArgument<T0>>) => {
        return new CommitUpgrade([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<CommitUpgrade<ToPhantomTypeArgument<T0>>>> {
    return phantom(CommitUpgrade.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): CommitUpgrade<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isCommitUpgrade(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a CommitUpgrade object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<CommitUpgrade<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching CommitUpgrade object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isCommitUpgrade(res.data.bcs.type)
    ) {
...
export function isUpgradeCapDeposited(type: string): boolean {
  ...
  return type.startsWith(
    `${PKG_V1}::upgrade_service::UpgradeCapDeposited` + "<"
  );
}

export interface UpgradeCapDepositedFields<T0 extends PhantomTypeArgument> {
  upgradeCapId: ToField<ID>;
}

export type UpgradeCapDepositedReified<T0 extends PhantomTypeArgument> =
  Reified<UpgradeCapDeposited<T0>, UpgradeCapDepositedFields<T0>>;

export class UpgradeCapDeposited<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::upgrade_service::UpgradeCapDeposited<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: UpgradeCapDepositedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      UpgradeCapDeposited.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::upgrade_service::UpgradeCapDeposited<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): UpgradeCapDepositedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: UpgradeCapDeposited.$typeName,
      fullTypeName: composeSuiType(
        UpgradeCapDeposited.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::upgrade_service::UpgradeCapDeposited<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        UpgradeCapDeposited.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        UpgradeCapDeposited.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => UpgradeCapDeposited.fromBcs(T0, data),
      bcs: UpgradeCapDeposited.bcs,
      fromJSONField: (field: any) =>
        UpgradeCapDeposited.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        UpgradeCapDeposited.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeCapDeposited.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeCapDeposited.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeCapDeposited.fetch(client, T0, id),
      new: (fields: UpgradeCapDepositedFields<ToPhantomTypeArgument<T0>>) => {
        return new UpgradeCapDeposited([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<UpgradeCapDeposited<ToPhantomTypeArgument<T0>>>> {
    return phantom(UpgradeCapDeposited.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): UpgradeCapDeposited<ToPhantomTypeArgument<T0>> {
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return UpgradeCapDeposited.reified(typeArg).new({
      upgradeCapId: decodeFromFieldsWithTypes(
        ID.reified(),
        item.fields.upgrade_cap_id
      ),
    });
  }
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return UpgradeCapDeposited.fromFields(
      typeArg,
      UpgradeCapDeposited.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isUpgradeCapDeposited(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a UpgradeCapDeposited object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isUpgradeCapDeposited(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<UpgradeCapDeposited<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching UpgradeCapDeposited object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isUpgradeCapDeposited(res.data.bcs.type)
    ) {
...
export function isUpgradeCapExtracted(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    `${PKG_V1}::upgrade_service::UpgradeCapExtracted` + "<"
  );
}

export interface UpgradeCapExtractedFields<T0 extends PhantomTypeArgument> {
  upgradeCapId: ToField<ID>;
}

export type UpgradeCapExtractedReified<T0 extends PhantomTypeArgument> =
  Reified<UpgradeCapExtracted<T0>, UpgradeCapExtractedFields<T0>>;

export class UpgradeCapExtracted<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::upgrade_service::UpgradeCapExtracted<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: UpgradeCapExtractedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      UpgradeCapExtracted.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::upgrade_service::UpgradeCapExtracted<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): UpgradeCapExtractedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: UpgradeCapExtracted.$typeName,
      fullTypeName: composeSuiType(
        UpgradeCapExtracted.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::upgrade_service::UpgradeCapExtracted<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        UpgradeCapExtracted.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        UpgradeCapExtracted.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => UpgradeCapExtracted.fromBcs(T0, data),
      bcs: UpgradeCapExtracted.bcs,
      fromJSONField: (field: any) =>
        UpgradeCapExtracted.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        UpgradeCapExtracted.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeCapExtracted.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeCapExtracted.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeCapExtracted.fetch(client, T0, id),
      new: (fields: UpgradeCapExtractedFields<ToPhantomTypeArgument<T0>>) => {
        return new UpgradeCapExtracted([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<UpgradeCapExtracted<ToPhantomTypeArgument<T0>>>> {
    return phantom(UpgradeCapExtracted.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): UpgradeCapExtracted<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return UpgradeCapExtracted.fromFields(
      typeArg,
      UpgradeCapExtracted.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isUpgradeCapExtracted(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a UpgradeCapExtracted object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isUpgradeCapExtracted(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<UpgradeCapExtracted<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching UpgradeCapExtracted object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isUpgradeCapExtracted(res.data.bcs.type)
    ) {
...
export class UpgradeCapKey implements StructClass {
  ...
  static reified(): UpgradeCapKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        UpgradeCapKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        UpgradeCapKey.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeCapKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeCapKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeCapKey.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): UpgradeCapKey {
    ...
    if (!isUpgradeCapKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a UpgradeCapKey object`
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<UpgradeCapKey> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching UpgradeCapKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isUpgradeCapKey(res.data.bcs.type)
    ) {
...
export interface UpgradeServiceFields<T0 extends PhantomTypeArgument> {
  id: ToField<UID>;
  admin: ToField<TwoStepRole<ToPhantom<AdminRole<T0>>>>;
}

export type UpgradeServiceReified<T0 extends PhantomTypeArgument> = Reified<
  UpgradeService<T0>,
  UpgradeServiceFields<T0>
>;

export class UpgradeService<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::upgrade_service::UpgradeService<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  readonly $isPhantom = UpgradeService.$isPhantom;

  readonly id: ToField<UID>;
  readonly admin: ToField<TwoStepRole<ToPhantom<AdminRole<T0>>>>;

  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: UpgradeServiceFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      UpgradeService.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::upgrade_service::UpgradeService<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): UpgradeServiceReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: UpgradeService.$typeName,
      fullTypeName: composeSuiType(
        UpgradeService.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::upgrade_service::UpgradeService<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        UpgradeService.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        UpgradeService.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => UpgradeService.fromBcs(T0, data),
      bcs: UpgradeService.bcs,
      fromJSONField: (field: any) => UpgradeService.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        UpgradeService.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeService.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeService.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeService.fetch(client, T0, id),
      new: (fields: UpgradeServiceFields<ToPhantomTypeArgument<T0>>) => {
        return new UpgradeService([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<UpgradeService<ToPhantomTypeArgument<T0>>>> {
    return phantom(UpgradeService.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): UpgradeService<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isUpgradeService(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a UpgradeService object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isUpgradeService(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<UpgradeService<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching UpgradeService object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isUpgradeService(res.data.bcs.type)
    ) {
...
export function isUpgradeServiceDestroyed(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    `${PKG_V1}::upgrade_service::UpgradeServiceDestroyed` + "<"
  );
}

export interface UpgradeServiceDestroyedFields<T0 extends PhantomTypeArgument> {
  dummyField: ToField<"bool">;
}

export type UpgradeServiceDestroyedReified<T0 extends PhantomTypeArgument> =
  Reified<UpgradeServiceDestroyed<T0>, UpgradeServiceDestroyedFields<T0>>;

export class UpgradeServiceDestroyed<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::upgrade_service::UpgradeServiceDestroyed<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: UpgradeServiceDestroyedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      UpgradeServiceDestroyed.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::upgrade_service::UpgradeServiceDestroyed<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): UpgradeServiceDestroyedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: UpgradeServiceDestroyed.$typeName,
      fullTypeName: composeSuiType(
        UpgradeServiceDestroyed.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::upgrade_service::UpgradeServiceDestroyed<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        UpgradeServiceDestroyed.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        UpgradeServiceDestroyed.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => UpgradeServiceDestroyed.fromBcs(T0, data),
      bcs: UpgradeServiceDestroyed.bcs,
      fromJSONField: (field: any) =>
        UpgradeServiceDestroyed.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        UpgradeServiceDestroyed.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeServiceDestroyed.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeServiceDestroyed.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeServiceDestroyed.fetch(client, T0, id),
      new: (
        fields: UpgradeServiceDestroyedFields<ToPhantomTypeArgument<T0>>
      ) => {
        return new UpgradeServiceDestroyed([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<UpgradeServiceDestroyed<ToPhantomTypeArgument<T0>>>
  > {
    return phantom(UpgradeServiceDestroyed.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): UpgradeServiceDestroyed<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return UpgradeServiceDestroyed.fromFields(
      typeArg,
      UpgradeServiceDestroyed.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isUpgradeServiceDestroyed(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a UpgradeServiceDestroyed object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isUpgradeServiceDestroyed(data.bcs.type)
      ) {
      ...
      return UpgradeServiceDestroyed.fromBcs(
        typeArg,
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<UpgradeServiceDestroyed<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
    ...
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isUpgradeServiceDestroyed(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a UpgradeServiceDestroyed object`
      );
    }
