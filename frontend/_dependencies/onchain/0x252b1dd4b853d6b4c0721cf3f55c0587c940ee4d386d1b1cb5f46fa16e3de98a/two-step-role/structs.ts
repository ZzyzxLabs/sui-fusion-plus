...
export interface RoleTransferStartedFields<T0 extends PhantomTypeArgument> {
  oldAddress: ToField<"address">;
  newAddress: ToField<"address">;
}

export type RoleTransferStartedReified<T0 extends PhantomTypeArgument> =
  Reified<RoleTransferStarted<T0>, RoleTransferStartedFields<T0>>;

export class RoleTransferStarted<T0 extends PhantomTypeArgument>
  implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::two_step_role::RoleTransferStarted<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    fields: RoleTransferStartedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      RoleTransferStarted.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::two_step_role::RoleTransferStarted<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): RoleTransferStartedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: RoleTransferStarted.$typeName,
      fullTypeName: composeSuiType(
        RoleTransferStarted.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::two_step_role::RoleTransferStarted<${PhantomToTypeStr<
      ...
      fromFields: (fields: Record<string, any>) =>
        RoleTransferStarted.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RoleTransferStarted.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => RoleTransferStarted.fromBcs(T0, data),
      bcs: RoleTransferStarted.bcs,
      fromJSONField: (field: any) =>
        RoleTransferStarted.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        RoleTransferStarted.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        RoleTransferStarted.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        RoleTransferStarted.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        RoleTransferStarted.fetch(client, T0, id),
      new: (fields: RoleTransferStartedFields<ToPhantomTypeArgument<T0>>) => {
        return new RoleTransferStarted([extractType(T0)], fields);
      },
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<RoleTransferStarted<ToPhantomTypeArgument<T0>>>> {
    return phantom(RoleTransferStarted.reified(T0));
  }
  static get p() {
  ...
  ): RoleTransferStarted<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return RoleTransferStarted.fromFields(
      typeArg,
      RoleTransferStarted.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isRoleTransferStarted(content.type)) {
      throw new Error(
        ...
        } is not a RoleTransferStarted object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        ...
        !isRoleTransferStarted(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<RoleTransferStarted<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching RoleTransferStarted object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isRoleTransferStarted(res.data.bcs.type)
    ) {
...
export interface RoleTransferredFields<T0 extends PhantomTypeArgument> {
  oldAddress: ToField<"address">;
  newAddress: ToField<"address">;
}

export type RoleTransferredReified<T0 extends PhantomTypeArgument> = Reified<
  RoleTransferred<T0>,
  RoleTransferredFields<T0>
>;

export class RoleTransferred<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::two_step_role::RoleTransferred<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: RoleTransferredFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      RoleTransferred.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::two_step_role::RoleTransferred<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): RoleTransferredReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: RoleTransferred.$typeName,
      fullTypeName: composeSuiType(
        RoleTransferred.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::two_step_role::RoleTransferred<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        RoleTransferred.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RoleTransferred.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => RoleTransferred.fromBcs(T0, data),
      bcs: RoleTransferred.bcs,
      fromJSONField: (field: any) => RoleTransferred.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        RoleTransferred.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        RoleTransferred.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        RoleTransferred.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        RoleTransferred.fetch(client, T0, id),
      new: (fields: RoleTransferredFields<ToPhantomTypeArgument<T0>>) => {
        return new RoleTransferred([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<RoleTransferred<ToPhantomTypeArgument<T0>>>> {
    return phantom(RoleTransferred.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): RoleTransferred<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isRoleTransferred(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a RoleTransferred object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isRoleTransferred(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<RoleTransferred<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching RoleTransferred object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isRoleTransferred(res.data.bcs.type)
    ) {
...
export interface TwoStepRoleFields<T0 extends PhantomTypeArgument> {
  activeAddress: ToField<"address">;
  pendingAddress: ToField<Option<"address">>;
}

export type TwoStepRoleReified<T0 extends PhantomTypeArgument> = Reified<
  TwoStepRole<T0>,
  TwoStepRoleFields<T0>
>;

export class TwoStepRole<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::two_step_role::TwoStepRole<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: TwoStepRoleFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      TwoStepRole.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::two_step_role::TwoStepRole<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): TwoStepRoleReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: TwoStepRole.$typeName,
      fullTypeName: composeSuiType(
        TwoStepRole.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::two_step_role::TwoStepRole<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        TwoStepRole.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TwoStepRole.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => TwoStepRole.fromBcs(T0, data),
      bcs: TwoStepRole.bcs,
      fromJSONField: (field: any) => TwoStepRole.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => TwoStepRole.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TwoStepRole.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TwoStepRole.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        TwoStepRole.fetch(client, T0, id),
      new: (fields: TwoStepRoleFields<ToPhantomTypeArgument<T0>>) => {
        return new TwoStepRole([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<TwoStepRole<ToPhantomTypeArgument<T0>>>> {
    return phantom(TwoStepRole.reified(T0));
  }
  static get p() {
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TwoStepRole.reified(typeArg).new({
      activeAddress: decodeFromFieldsWithTypes(
        "address",
        item.fields.active_address
      ),
  ...
  static fromJSONField<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TwoStepRole.reified(typeArg).new({
      ...
      pendingAddress: decodeFromJSONField(
        Option.reified("address"),
        field.pendingAddress
      ),
    });
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isTwoStepRole(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TwoStepRole object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<TwoStepRole<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching TwoStepRole object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isTwoStepRole(res.data.bcs.type)
    ) {
