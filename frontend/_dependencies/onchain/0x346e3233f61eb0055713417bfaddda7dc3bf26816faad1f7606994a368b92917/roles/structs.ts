...
export interface BlocklisterChangedFields<T0 extends PhantomTypeArgument> {
  oldBlocklister: ToField<"address">;
  newBlocklister: ToField<"address">;
}

export type BlocklisterChangedReified<T0 extends PhantomTypeArgument> = Reified<
  BlocklisterChanged<T0>,
  BlocklisterChangedFields<T0>
>;

export class BlocklisterChanged<T0 extends PhantomTypeArgument>
  implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::roles::BlocklisterChanged<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    fields: BlocklisterChangedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      BlocklisterChanged.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::roles::BlocklisterChanged<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): BlocklisterChangedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: BlocklisterChanged.$typeName,
      fullTypeName: composeSuiType(
        BlocklisterChanged.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::roles::BlocklisterChanged<${PhantomToTypeStr<
      ...
      fromFields: (fields: Record<string, any>) =>
        BlocklisterChanged.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        BlocklisterChanged.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => BlocklisterChanged.fromBcs(T0, data),
      bcs: BlocklisterChanged.bcs,
      fromJSONField: (field: any) =>
        BlocklisterChanged.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        BlocklisterChanged.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        BlocklisterChanged.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        BlocklisterChanged.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        BlocklisterChanged.fetch(client, T0, id),
      new: (fields: BlocklisterChangedFields<ToPhantomTypeArgument<T0>>) => {
        return new BlocklisterChanged([extractType(T0)], fields);
      },
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<BlocklisterChanged<ToPhantomTypeArgument<T0>>>> {
    return phantom(BlocklisterChanged.reified(T0));
  }
  static get p() {
  ...
  ): BlocklisterChanged<ToPhantomTypeArgument<T0>> {
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BlocklisterChanged.reified(typeArg).new({
      oldBlocklister: decodeFromFieldsWithTypes(
        "address",
        item.fields.old_blocklister
      ),
      newBlocklister: decodeFromFieldsWithTypes(
        "address",
        item.fields.new_blocklister
      ),
    });
  }
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BlocklisterChanged.fromFields(
      typeArg,
      BlocklisterChanged.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isBlocklisterChanged(content.type)) {
      throw new Error(
        ...
        } is not a BlocklisterChanged object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        ...
        !isBlocklisterChanged(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<BlocklisterChanged<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching BlocklisterChanged object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isBlocklisterChanged(res.data.bcs.type)
    ) {
...
export type BlocklisterKeyReified = Reified<
  BlocklisterKey,
  BlocklisterKeyFields
>;
...
export class BlocklisterKey implements StructClass {
  ...
  static reified(): BlocklisterKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        BlocklisterKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        BlocklisterKey.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        BlocklisterKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        BlocklisterKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        BlocklisterKey.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): BlocklisterKey {
    ...
    if (!isBlocklisterKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a BlocklisterKey object`
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): BlocklisterKey {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isBlocklisterKey(data.bcs.type)
      ) {
  ...
  static async fetch(client: SuiClient, id: string): Promise<BlocklisterKey> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching BlocklisterKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isBlocklisterKey(res.data.bcs.type)
    ) {
...
export interface MasterMinterChangedFields<T0 extends PhantomTypeArgument> {
  oldMasterMinter: ToField<"address">;
  newMasterMinter: ToField<"address">;
}

export type MasterMinterChangedReified<T0 extends PhantomTypeArgument> =
  Reified<MasterMinterChanged<T0>, MasterMinterChangedFields<T0>>;

export class MasterMinterChanged<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::roles::MasterMinterChanged<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MasterMinterChangedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MasterMinterChanged.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::roles::MasterMinterChanged<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MasterMinterChangedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MasterMinterChanged.$typeName,
      fullTypeName: composeSuiType(
        MasterMinterChanged.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::roles::MasterMinterChanged<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MasterMinterChanged.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MasterMinterChanged.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MasterMinterChanged.fromBcs(T0, data),
      bcs: MasterMinterChanged.bcs,
      fromJSONField: (field: any) =>
        MasterMinterChanged.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MasterMinterChanged.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MasterMinterChanged.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MasterMinterChanged.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MasterMinterChanged.fetch(client, T0, id),
      new: (fields: MasterMinterChangedFields<ToPhantomTypeArgument<T0>>) => {
        return new MasterMinterChanged([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MasterMinterChanged<ToPhantomTypeArgument<T0>>>> {
    return phantom(MasterMinterChanged.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MasterMinterChanged<ToPhantomTypeArgument<T0>> {
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MasterMinterChanged.reified(typeArg).new({
      oldMasterMinter: decodeFromFieldsWithTypes(
        "address",
        item.fields.old_master_minter
      ),
      newMasterMinter: decodeFromFieldsWithTypes(
        "address",
        item.fields.new_master_minter
      ),
    });
  }
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MasterMinterChanged.fromFields(
      typeArg,
      MasterMinterChanged.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMasterMinterChanged(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MasterMinterChanged object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMasterMinterChanged(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MasterMinterChanged<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MasterMinterChanged object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMasterMinterChanged(res.data.bcs.type)
    ) {
...
export type MasterMinterKeyReified = Reified<
  MasterMinterKey,
  MasterMinterKeyFields
>;
...
export class MasterMinterKey implements StructClass {
  ...
  static reified(): MasterMinterKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        MasterMinterKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MasterMinterKey.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        MasterMinterKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MasterMinterKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        MasterMinterKey.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): MasterMinterKey {
    ...
    if (!isMasterMinterKey(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MasterMinterKey object`
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): MasterMinterKey {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMasterMinterKey(data.bcs.type)
      ) {
  ...
  static async fetch(client: SuiClient, id: string): Promise<MasterMinterKey> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching MasterMinterKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMasterMinterKey(res.data.bcs.type)
    ) {
...
export interface MetadataUpdaterChangedFields<T0 extends PhantomTypeArgument> {
  oldMetadataUpdater: ToField<"address">;
  newMetadataUpdater: ToField<"address">;
}

export type MetadataUpdaterChangedReified<T0 extends PhantomTypeArgument> =
  Reified<MetadataUpdaterChanged<T0>, MetadataUpdaterChangedFields<T0>>;

export class MetadataUpdaterChanged<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::roles::MetadataUpdaterChanged<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MetadataUpdaterChangedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MetadataUpdaterChanged.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::roles::MetadataUpdaterChanged<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MetadataUpdaterChangedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MetadataUpdaterChanged.$typeName,
      fullTypeName: composeSuiType(
        MetadataUpdaterChanged.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::roles::MetadataUpdaterChanged<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MetadataUpdaterChanged.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MetadataUpdaterChanged.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MetadataUpdaterChanged.fromBcs(T0, data),
      bcs: MetadataUpdaterChanged.bcs,
      fromJSONField: (field: any) =>
        MetadataUpdaterChanged.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MetadataUpdaterChanged.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MetadataUpdaterChanged.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MetadataUpdaterChanged.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MetadataUpdaterChanged.fetch(client, T0, id),
      new: (
        fields: MetadataUpdaterChangedFields<ToPhantomTypeArgument<T0>>
      ) => {
        return new MetadataUpdaterChanged([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<MetadataUpdaterChanged<ToPhantomTypeArgument<T0>>>
  > {
    return phantom(MetadataUpdaterChanged.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MetadataUpdaterChanged<ToPhantomTypeArgument<T0>> {
    return MetadataUpdaterChanged.reified(typeArg).new({
      oldMetadataUpdater: decodeFromFields(
        "address",
        fields.old_metadata_updater
      ),
      newMetadataUpdater: decodeFromFields(
        "address",
        fields.new_metadata_updater
      ),
    });
  }
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MetadataUpdaterChanged.reified(typeArg).new({
      oldMetadataUpdater: decodeFromFieldsWithTypes(
        "address",
        item.fields.old_metadata_updater
      ),
      newMetadataUpdater: decodeFromFieldsWithTypes(
        "address",
        item.fields.new_metadata_updater
      ),
    });
  }
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MetadataUpdaterChanged.fromFields(
      typeArg,
      MetadataUpdaterChanged.bcs.parse(data)
    );
  }
  ...
  static fromJSONField<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MetadataUpdaterChanged.reified(typeArg).new({
      oldMetadataUpdater: decodeFromJSONField(
        "address",
        field.oldMetadataUpdater
      ),
      newMetadataUpdater: decodeFromJSONField(
        "address",
        field.newMetadataUpdater
      ),
    });
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMetadataUpdaterChanged(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MetadataUpdaterChanged object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMetadataUpdaterChanged(data.bcs.type)
      ) {
      ...
      return MetadataUpdaterChanged.fromBcs(
        typeArg,
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MetadataUpdaterChanged<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MetadataUpdaterChanged object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMetadataUpdaterChanged(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a MetadataUpdaterChanged object`
      );
    }
...
export type MetadataUpdaterKeyReified = Reified<
  MetadataUpdaterKey,
  MetadataUpdaterKeyFields
>;
...
export class MetadataUpdaterKey implements StructClass {
  ...
  static reified(): MetadataUpdaterKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        MetadataUpdaterKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MetadataUpdaterKey.fromFieldsWithTypes(item),
      ...
      fromJSON: (json: Record<string, any>) =>
        MetadataUpdaterKey.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MetadataUpdaterKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MetadataUpdaterKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        MetadataUpdaterKey.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): MetadataUpdaterKey {
    ...
    if (!isMetadataUpdaterKey(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MetadataUpdaterKey object`
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): MetadataUpdaterKey {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMetadataUpdaterKey(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SuiClient,
    id: string
  ): Promise<MetadataUpdaterKey> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MetadataUpdaterKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMetadataUpdaterKey(res.data.bcs.type)
    ) {
...
export class OwnerKey implements StructClass {
  ...
  static async fetch(client: SuiClient, id: string): Promise<OwnerKey> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching OwnerKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isOwnerKey(res.data.bcs.type)
    ) {
...
export interface OwnerRoleFields<T0 extends PhantomTypeArgument> {
  dummyField: ToField<"bool">;
}

export type OwnerRoleReified<T0 extends PhantomTypeArgument> = Reified<
  OwnerRole<T0>,
  OwnerRoleFields<T0>
>;

export class OwnerRole<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::roles::OwnerRole<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: OwnerRoleFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      OwnerRole.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::roles::OwnerRole<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): OwnerRoleReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: OwnerRole.$typeName,
      fullTypeName: composeSuiType(
        OwnerRole.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::roles::OwnerRole<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        OwnerRole.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        OwnerRole.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => OwnerRole.fromBcs(T0, data),
      bcs: OwnerRole.bcs,
      fromJSONField: (field: any) => OwnerRole.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => OwnerRole.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        OwnerRole.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        OwnerRole.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        OwnerRole.fetch(client, T0, id),
      new: (fields: OwnerRoleFields<ToPhantomTypeArgument<T0>>) => {
        return new OwnerRole([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<OwnerRole<ToPhantomTypeArgument<T0>>>> {
    return phantom(OwnerRole.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): OwnerRole<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isOwnerRole(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a OwnerRole object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<OwnerRole<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching OwnerRole object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isOwnerRole(res.data.bcs.type)
    ) {
...
export interface PauserChangedFields<T0 extends PhantomTypeArgument> {
  oldPauser: ToField<"address">;
  newPauser: ToField<"address">;
}

export type PauserChangedReified<T0 extends PhantomTypeArgument> = Reified<
  PauserChanged<T0>,
  PauserChangedFields<T0>
>;

export class PauserChanged<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::roles::PauserChanged<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: PauserChangedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      PauserChanged.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::roles::PauserChanged<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PauserChangedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: PauserChanged.$typeName,
      fullTypeName: composeSuiType(
        PauserChanged.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::roles::PauserChanged<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        PauserChanged.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PauserChanged.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => PauserChanged.fromBcs(T0, data),
      bcs: PauserChanged.bcs,
      fromJSONField: (field: any) => PauserChanged.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => PauserChanged.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        PauserChanged.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        PauserChanged.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        PauserChanged.fetch(client, T0, id),
      new: (fields: PauserChangedFields<ToPhantomTypeArgument<T0>>) => {
        return new PauserChanged([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<PauserChanged<ToPhantomTypeArgument<T0>>>> {
    return phantom(PauserChanged.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): PauserChanged<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isPauserChanged(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a PauserChanged object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<PauserChanged<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching PauserChanged object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isPauserChanged(res.data.bcs.type)
    ) {
...
export class PauserKey implements StructClass {
  ...
  static reified(): PauserKeyReified {
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PauserKey.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        PauserKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        PauserKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        PauserKey.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): PauserKey {
    ...
    if (!isPauserKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a PauserKey object`
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<PauserKey> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching PauserKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isPauserKey(res.data.bcs.type)
    ) {
...
export interface RolesFields<T0 extends PhantomTypeArgument> {
  data: ToField<Bag>;
}

export type RolesReified<T0 extends PhantomTypeArgument> = Reified<
  Roles<T0>,
  RolesFields<T0>
>;

export class Roles<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::roles::Roles<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: RolesFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Roles.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::roles::Roles<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): RolesReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Roles.$typeName,
      fullTypeName: composeSuiType(
        Roles.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::roles::Roles<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) => Roles.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Roles.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Roles.fromBcs(T0, data),
      bcs: Roles.bcs,
      fromJSONField: (field: any) => Roles.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Roles.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Roles.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Roles.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Roles.fetch(client, T0, id),
      new: (fields: RolesFields<ToPhantomTypeArgument<T0>>) => {
        return new Roles([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Roles<ToPhantomTypeArgument<T0>>>> {
    return phantom(Roles.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): Roles<ToPhantomTypeArgument<T0>> {
    return Roles.reified(typeArg).new({
      data: decodeFromFields(Bag.reified(), fields.data),
    });
  }
  ...
  static fromJSONField<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Roles.reified(typeArg).new({
      data: decodeFromJSONField(Bag.reified(), field.data),
    });
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isRoles(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Roles object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Roles<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching Roles object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isRoles(res.data.bcs.type)
    ) {
