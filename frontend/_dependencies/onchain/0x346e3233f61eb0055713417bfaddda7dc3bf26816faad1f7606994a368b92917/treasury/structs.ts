...
export interface BlocklistedFields<T0 extends PhantomTypeArgument> {
  address: ToField<"address">;
}

export type BlocklistedReified<T0 extends PhantomTypeArgument> = Reified<
  Blocklisted<T0>,
  BlocklistedFields<T0>
>;

export class Blocklisted<T0 extends PhantomTypeArgument>
  implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::Blocklisted<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    fields: BlocklistedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Blocklisted.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::Blocklisted<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): BlocklistedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Blocklisted.$typeName,
      fullTypeName: composeSuiType(
        Blocklisted.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::Blocklisted<${PhantomToTypeStr<
      ...
      fromFields: (fields: Record<string, any>) =>
        Blocklisted.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Blocklisted.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Blocklisted.fromBcs(T0, data),
      bcs: Blocklisted.bcs,
      fromJSONField: (field: any) => Blocklisted.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Blocklisted.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Blocklisted.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Blocklisted.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Blocklisted.fetch(client, T0, id),
      new: (fields: BlocklistedFields<ToPhantomTypeArgument<T0>>) => {
        return new Blocklisted([extractType(T0)], fields);
      },
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Blocklisted<ToPhantomTypeArgument<T0>>>> {
    return phantom(Blocklisted.reified(T0));
  }
  static get p() {
  ...
  ): Blocklisted<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isBlocklisted(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Blocklisted object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Blocklisted<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching Blocklisted object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isBlocklisted(res.data.bcs.type)
    ) {
...
export interface BurnFields<T0 extends PhantomTypeArgument> {
  mintCap: ToField<ID>;
  amount: ToField<"u64">;
}

export type BurnReified<T0 extends PhantomTypeArgument> = Reified<
  Burn<T0>,
  BurnFields<T0>
>;

export class Burn<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::Burn<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: BurnFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Burn.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::Burn<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): BurnReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Burn.$typeName,
      fullTypeName: composeSuiType(
        Burn.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::Burn<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) => Burn.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Burn.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Burn.fromBcs(T0, data),
      bcs: Burn.bcs,
      fromJSONField: (field: any) => Burn.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Burn.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Burn.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Burn.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Burn.fetch(client, T0, id),
      new: (fields: BurnFields<ToPhantomTypeArgument<T0>>) => {
        return new Burn([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Burn<ToPhantomTypeArgument<T0>>>> {
    return phantom(Burn.reified(T0));
  }
  static get p() {
    return Burn.phantom;
  }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Burn<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
...
export interface ControllerConfiguredFields<T0 extends PhantomTypeArgument> {
  controller: ToField<"address">;
  mintCap: ToField<ID>;
}

export type ControllerConfiguredReified<T0 extends PhantomTypeArgument> =
  Reified<ControllerConfigured<T0>, ControllerConfiguredFields<T0>>;

export class ControllerConfigured<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::ControllerConfigured<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: ControllerConfiguredFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      ControllerConfigured.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::ControllerConfigured<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): ControllerConfiguredReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: ControllerConfigured.$typeName,
      fullTypeName: composeSuiType(
        ControllerConfigured.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::ControllerConfigured<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        ControllerConfigured.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        ControllerConfigured.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => ControllerConfigured.fromBcs(T0, data),
      bcs: ControllerConfigured.bcs,
      fromJSONField: (field: any) =>
        ControllerConfigured.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        ControllerConfigured.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        ControllerConfigured.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        ControllerConfigured.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        ControllerConfigured.fetch(client, T0, id),
      new: (fields: ControllerConfiguredFields<ToPhantomTypeArgument<T0>>) => {
        return new ControllerConfigured([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<ControllerConfigured<ToPhantomTypeArgument<T0>>>
  > {
    return phantom(ControllerConfigured.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): ControllerConfigured<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return ControllerConfigured.fromFields(
      typeArg,
      ControllerConfigured.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isControllerConfigured(content.type)) {
      throw new Error(
        ...
        } is not a ControllerConfigured object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        ...
        !isControllerConfigured(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<ControllerConfigured<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching ControllerConfigured object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isControllerConfigured(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a ControllerConfigured object`
      );
    }
...
export interface ControllerRemovedFields<T0 extends PhantomTypeArgument> {
  controller: ToField<"address">;
}

export type ControllerRemovedReified<T0 extends PhantomTypeArgument> = Reified<
  ControllerRemoved<T0>,
  ControllerRemovedFields<T0>
>;

export class ControllerRemoved<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::ControllerRemoved<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: ControllerRemovedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      ControllerRemoved.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::ControllerRemoved<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): ControllerRemovedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: ControllerRemoved.$typeName,
      fullTypeName: composeSuiType(
        ControllerRemoved.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::ControllerRemoved<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        ControllerRemoved.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        ControllerRemoved.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => ControllerRemoved.fromBcs(T0, data),
      bcs: ControllerRemoved.bcs,
      fromJSONField: (field: any) => ControllerRemoved.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        ControllerRemoved.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        ControllerRemoved.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        ControllerRemoved.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        ControllerRemoved.fetch(client, T0, id),
      new: (fields: ControllerRemovedFields<ToPhantomTypeArgument<T0>>) => {
        return new ControllerRemoved([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<ControllerRemoved<ToPhantomTypeArgument<T0>>>> {
    return phantom(ControllerRemoved.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): ControllerRemoved<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return ControllerRemoved.fromFields(
      typeArg,
      ControllerRemoved.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isControllerRemoved(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a ControllerRemoved object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isControllerRemoved(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<ControllerRemoved<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching ControllerRemoved object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isControllerRemoved(res.data.bcs.type)
    ) {
...
export class DenyCapKey implements StructClass {
  ...
  static reified(): DenyCapKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        DenyCapKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DenyCapKey.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        DenyCapKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        DenyCapKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        DenyCapKey.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): DenyCapKey {
    ...
    if (!isDenyCapKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a DenyCapKey object`
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<DenyCapKey> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching DenyCapKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isDenyCapKey(res.data.bcs.type)
    ) {
...
export interface MetadataUpdatedFields<T0 extends PhantomTypeArgument> {
  name: ToField<String>;
...
export type MetadataUpdatedReified<T0 extends PhantomTypeArgument> = Reified<
  MetadataUpdated<T0>,
  MetadataUpdatedFields<T0>
>;

export class MetadataUpdated<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MetadataUpdated<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MetadataUpdatedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MetadataUpdated.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MetadataUpdated<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MetadataUpdatedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MetadataUpdated.$typeName,
      fullTypeName: composeSuiType(
        MetadataUpdated.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MetadataUpdated<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MetadataUpdated.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MetadataUpdated.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MetadataUpdated.fromBcs(T0, data),
      bcs: MetadataUpdated.bcs,
      fromJSONField: (field: any) => MetadataUpdated.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MetadataUpdated.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MetadataUpdated.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MetadataUpdated.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MetadataUpdated.fetch(client, T0, id),
      new: (fields: MetadataUpdatedFields<ToPhantomTypeArgument<T0>>) => {
        return new MetadataUpdated([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MetadataUpdated<ToPhantomTypeArgument<T0>>>> {
    return phantom(MetadataUpdated.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MetadataUpdated<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMetadataUpdated(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MetadataUpdated object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMetadataUpdated(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MetadataUpdated<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MetadataUpdated object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMetadataUpdated(res.data.bcs.type)
    ) {
...
export interface MigrationAbortedFields<T0 extends PhantomTypeArgument> {
  compatibleVersions: ToField<Vector<"u64">>;
}

export type MigrationAbortedReified<T0 extends PhantomTypeArgument> = Reified<
  MigrationAborted<T0>,
  MigrationAbortedFields<T0>
>;

export class MigrationAborted<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MigrationAborted<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MigrationAbortedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MigrationAborted.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MigrationAborted<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MigrationAbortedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MigrationAborted.$typeName,
      fullTypeName: composeSuiType(
        MigrationAborted.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MigrationAborted<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MigrationAborted.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MigrationAborted.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MigrationAborted.fromBcs(T0, data),
      bcs: MigrationAborted.bcs,
      fromJSONField: (field: any) => MigrationAborted.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MigrationAborted.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MigrationAborted.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MigrationAborted.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MigrationAborted.fetch(client, T0, id),
      new: (fields: MigrationAbortedFields<ToPhantomTypeArgument<T0>>) => {
        return new MigrationAborted([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MigrationAborted<ToPhantomTypeArgument<T0>>>> {
    return phantom(MigrationAborted.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MigrationAborted<ToPhantomTypeArgument<T0>> {
    return MigrationAborted.reified(typeArg).new({
      compatibleVersions: decodeFromFields(
        reified.vector("u64"),
        fields.compatible_versions
      ),
    });
  }
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MigrationAborted.fromFields(
      typeArg,
      MigrationAborted.bcs.parse(data)
    );
  }

  toJSONField() {
    return {
      compatibleVersions: fieldToJSON<Vector<"u64">>(
        `vector<u64>`,
  ...
  static fromJSONField<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MigrationAborted.reified(typeArg).new({
      compatibleVersions: decodeFromJSONField(
        reified.vector("u64"),
        field.compatibleVersions
      ),
    });
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMigrationAborted(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MigrationAborted object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMigrationAborted(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MigrationAborted<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MigrationAborted object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMigrationAborted(res.data.bcs.type)
    ) {
...
export interface MigrationCompletedFields<T0 extends PhantomTypeArgument> {
  compatibleVersions: ToField<Vector<"u64">>;
}

export type MigrationCompletedReified<T0 extends PhantomTypeArgument> = Reified<
  MigrationCompleted<T0>,
  MigrationCompletedFields<T0>
>;

export class MigrationCompleted<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MigrationCompleted<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MigrationCompletedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MigrationCompleted.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MigrationCompleted<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MigrationCompletedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MigrationCompleted.$typeName,
      fullTypeName: composeSuiType(
        MigrationCompleted.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MigrationCompleted<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MigrationCompleted.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MigrationCompleted.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MigrationCompleted.fromBcs(T0, data),
      bcs: MigrationCompleted.bcs,
      fromJSONField: (field: any) =>
        MigrationCompleted.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MigrationCompleted.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MigrationCompleted.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MigrationCompleted.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MigrationCompleted.fetch(client, T0, id),
      new: (fields: MigrationCompletedFields<ToPhantomTypeArgument<T0>>) => {
        return new MigrationCompleted([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MigrationCompleted<ToPhantomTypeArgument<T0>>>> {
    return phantom(MigrationCompleted.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MigrationCompleted<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MigrationCompleted.fromFields(
      typeArg,
      MigrationCompleted.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMigrationCompleted(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MigrationCompleted object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMigrationCompleted(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MigrationCompleted<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MigrationCompleted object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMigrationCompleted(res.data.bcs.type)
    ) {
...
export interface MigrationStartedFields<T0 extends PhantomTypeArgument> {
  compatibleVersions: ToField<Vector<"u64">>;
}

export type MigrationStartedReified<T0 extends PhantomTypeArgument> = Reified<
  MigrationStarted<T0>,
  MigrationStartedFields<T0>
>;

export class MigrationStarted<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MigrationStarted<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MigrationStartedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MigrationStarted.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MigrationStarted<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MigrationStartedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MigrationStarted.$typeName,
      fullTypeName: composeSuiType(
        MigrationStarted.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MigrationStarted<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MigrationStarted.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MigrationStarted.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MigrationStarted.fromBcs(T0, data),
      bcs: MigrationStarted.bcs,
      fromJSONField: (field: any) => MigrationStarted.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MigrationStarted.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MigrationStarted.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MigrationStarted.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MigrationStarted.fetch(client, T0, id),
      new: (fields: MigrationStartedFields<ToPhantomTypeArgument<T0>>) => {
        return new MigrationStarted([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MigrationStarted<ToPhantomTypeArgument<T0>>>> {
    return phantom(MigrationStarted.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MigrationStarted<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MigrationStarted.fromFields(
      typeArg,
      MigrationStarted.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMigrationStarted(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MigrationStarted object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMigrationStarted(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MigrationStarted<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MigrationStarted object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMigrationStarted(res.data.bcs.type)
    ) {
...
export interface MintFields<T0 extends PhantomTypeArgument> {
  mintCap: ToField<ID>;
  recipient: ToField<"address">;
  amount: ToField<"u64">;
}

export type MintReified<T0 extends PhantomTypeArgument> = Reified<
  Mint<T0>,
  MintFields<T0>
>;

export class Mint<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::Mint<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MintFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Mint.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::Mint<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MintReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Mint.$typeName,
      fullTypeName: composeSuiType(
        Mint.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::Mint<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) => Mint.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Mint.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Mint.fromBcs(T0, data),
      bcs: Mint.bcs,
      fromJSONField: (field: any) => Mint.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Mint.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Mint.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Mint.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Mint.fetch(client, T0, id),
      new: (fields: MintFields<ToPhantomTypeArgument<T0>>) => {
        return new Mint([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Mint<ToPhantomTypeArgument<T0>>>> {
    return phantom(Mint.reified(T0));
  }
  static get p() {
    return Mint.phantom;
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMint(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Mint object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Mint<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching Mint object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMint(res.data.bcs.type)
    ) {
...
export interface MintCapFields<T0 extends PhantomTypeArgument> {
  id: ToField<UID>;
}

export type MintCapReified<T0 extends PhantomTypeArgument> = Reified<
  MintCap<T0>,
  MintCapFields<T0>
>;

export class MintCap<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MintCap<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MintCapFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MintCap.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MintCap<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MintCapReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MintCap.$typeName,
      fullTypeName: composeSuiType(
        MintCap.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MintCap<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MintCap.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MintCap.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MintCap.fromBcs(T0, data),
      bcs: MintCap.bcs,
      fromJSONField: (field: any) => MintCap.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => MintCap.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MintCap.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MintCap.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MintCap.fetch(client, T0, id),
      new: (fields: MintCapFields<ToPhantomTypeArgument<T0>>) => {
        return new MintCap([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MintCap<ToPhantomTypeArgument<T0>>>> {
    return phantom(MintCap.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MintCap<ToPhantomTypeArgument<T0>> {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MintCap<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
...
export interface MintCapCreatedFields<T0 extends PhantomTypeArgument> {
  mintCap: ToField<ID>;
}

export type MintCapCreatedReified<T0 extends PhantomTypeArgument> = Reified<
  MintCapCreated<T0>,
  MintCapCreatedFields<T0>
>;

export class MintCapCreated<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MintCapCreated<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MintCapCreatedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MintCapCreated.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MintCapCreated<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MintCapCreatedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MintCapCreated.$typeName,
      fullTypeName: composeSuiType(
        MintCapCreated.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MintCapCreated<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MintCapCreated.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MintCapCreated.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MintCapCreated.fromBcs(T0, data),
      bcs: MintCapCreated.bcs,
      fromJSONField: (field: any) => MintCapCreated.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MintCapCreated.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MintCapCreated.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MintCapCreated.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MintCapCreated.fetch(client, T0, id),
      new: (fields: MintCapCreatedFields<ToPhantomTypeArgument<T0>>) => {
        return new MintCapCreated([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MintCapCreated<ToPhantomTypeArgument<T0>>>> {
    return phantom(MintCapCreated.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MintCapCreated<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMintCapCreated(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a MintCapCreated object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMintCapCreated(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MintCapCreated<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MintCapCreated object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMintCapCreated(res.data.bcs.type)
    ) {
...
export function isMinterAllowanceIncremented(type: string): boolean {
  ...
  return type.startsWith(
    `${PKG_V1}::treasury::MinterAllowanceIncremented` + "<"
  );
}

export interface MinterAllowanceIncrementedFields<
...
export type MinterAllowanceIncrementedReified<T0 extends PhantomTypeArgument> =
  Reified<MinterAllowanceIncremented<T0>, MinterAllowanceIncrementedFields<T0>>;

export class MinterAllowanceIncremented<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MinterAllowanceIncremented<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MinterAllowanceIncrementedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MinterAllowanceIncremented.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MinterAllowanceIncremented<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MinterAllowanceIncrementedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MinterAllowanceIncremented.$typeName,
      fullTypeName: composeSuiType(
        MinterAllowanceIncremented.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MinterAllowanceIncremented<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MinterAllowanceIncremented.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MinterAllowanceIncremented.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) =>
        MinterAllowanceIncremented.fromBcs(T0, data),
      bcs: MinterAllowanceIncremented.bcs,
      fromJSONField: (field: any) =>
        MinterAllowanceIncremented.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MinterAllowanceIncremented.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MinterAllowanceIncremented.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MinterAllowanceIncremented.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MinterAllowanceIncremented.fetch(client, T0, id),
      new: (
        fields: MinterAllowanceIncrementedFields<ToPhantomTypeArgument<T0>>
      ) => {
        return new MinterAllowanceIncremented([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<MinterAllowanceIncremented<ToPhantomTypeArgument<T0>>>
  > {
    return phantom(MinterAllowanceIncremented.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MinterAllowanceIncremented<ToPhantomTypeArgument<T0>> {
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MinterAllowanceIncremented.reified(typeArg).new({
      controller: decodeFromFieldsWithTypes("address", item.fields.controller),
      mintCap: decodeFromFieldsWithTypes(ID.reified(), item.fields.mint_cap),
      allowanceIncrement: decodeFromFieldsWithTypes(
        "u64",
        item.fields.allowance_increment
      ),
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMinterAllowanceIncremented(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MinterAllowanceIncremented object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMinterAllowanceIncremented(data.bcs.type)
      ) {
      ...
      return MinterAllowanceIncremented.fromBcs(
        typeArg,
        fromB64(data.bcs.bcsBytes)
      );
    }
    if (data.content) {
      return MinterAllowanceIncremented.fromSuiParsedData(
        typeArg,
        data.content
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MinterAllowanceIncremented<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
    ...
    if (
      ...
      throw new Error(
        `object at id ${id} is not a MinterAllowanceIncremented object`
      );
    }
...
export interface MinterConfiguredFields<T0 extends PhantomTypeArgument> {
  controller: ToField<"address">;
  mintCap: ToField<ID>;
  allowance: ToField<"u64">;
}

export type MinterConfiguredReified<T0 extends PhantomTypeArgument> = Reified<
  MinterConfigured<T0>,
  MinterConfiguredFields<T0>
>;

export class MinterConfigured<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MinterConfigured<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MinterConfiguredFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MinterConfigured.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MinterConfigured<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MinterConfiguredReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MinterConfigured.$typeName,
      fullTypeName: composeSuiType(
        MinterConfigured.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MinterConfigured<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MinterConfigured.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MinterConfigured.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MinterConfigured.fromBcs(T0, data),
      bcs: MinterConfigured.bcs,
      fromJSONField: (field: any) => MinterConfigured.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        MinterConfigured.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MinterConfigured.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MinterConfigured.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MinterConfigured.fetch(client, T0, id),
      new: (fields: MinterConfiguredFields<ToPhantomTypeArgument<T0>>) => {
        return new MinterConfigured([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MinterConfigured<ToPhantomTypeArgument<T0>>>> {
    return phantom(MinterConfigured.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MinterConfigured<ToPhantomTypeArgument<T0>> {
  ...
  static fromBcs<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MinterConfigured.fromFields(
      typeArg,
      MinterConfigured.bcs.parse(data)
    );
  }
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMinterConfigured(content.type)) {
      throw new Error(
        `object at ${
          (content.fields as any).id
        } is not a MinterConfigured object`
      );
    }
  ...
  static fromSuiObjectData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isMinterConfigured(data.bcs.type)
      ) {
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MinterConfigured<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MinterConfigured object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMinterConfigured(res.data.bcs.type)
    ) {
...
export interface MinterRemovedFields<T0 extends PhantomTypeArgument> {
  controller: ToField<"address">;
  mintCap: ToField<ID>;
}

export type MinterRemovedReified<T0 extends PhantomTypeArgument> = Reified<
  MinterRemoved<T0>,
  MinterRemovedFields<T0>
>;

export class MinterRemoved<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::MinterRemoved<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: MinterRemovedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      MinterRemoved.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::MinterRemoved<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): MinterRemovedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: MinterRemoved.$typeName,
      fullTypeName: composeSuiType(
        MinterRemoved.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::MinterRemoved<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        MinterRemoved.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MinterRemoved.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => MinterRemoved.fromBcs(T0, data),
      bcs: MinterRemoved.bcs,
      fromJSONField: (field: any) => MinterRemoved.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => MinterRemoved.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MinterRemoved.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MinterRemoved.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        MinterRemoved.fetch(client, T0, id),
      new: (fields: MinterRemovedFields<ToPhantomTypeArgument<T0>>) => {
        return new MinterRemoved([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<MinterRemoved<ToPhantomTypeArgument<T0>>>> {
    return phantom(MinterRemoved.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): MinterRemoved<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMinterRemoved(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a MinterRemoved object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<MinterRemoved<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching MinterRemoved object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMinterRemoved(res.data.bcs.type)
    ) {
...
export interface PauseFields<T0 extends PhantomTypeArgument> {
  dummyField: ToField<"bool">;
}

export type PauseReified<T0 extends PhantomTypeArgument> = Reified<
  Pause<T0>,
  PauseFields<T0>
>;

export class Pause<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::Pause<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: PauseFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Pause.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::Pause<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PauseReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Pause.$typeName,
      fullTypeName: composeSuiType(
        Pause.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::Pause<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) => Pause.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Pause.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Pause.fromBcs(T0, data),
      bcs: Pause.bcs,
      fromJSONField: (field: any) => Pause.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Pause.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Pause.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Pause.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Pause.fetch(client, T0, id),
      new: (fields: PauseFields<ToPhantomTypeArgument<T0>>) => {
        return new Pause([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Pause<ToPhantomTypeArgument<T0>>>> {
    return phantom(Pause.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): Pause<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isPause(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Pause object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Pause<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching Pause object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isPause(res.data.bcs.type)
    ) {
...
export interface TreasuryFields<T0 extends PhantomTypeArgument> {
  id: ToField<UID>;
  controllers: ToField<Table<"address", ToPhantom<ID>>>;
  mintAllowances: ToField<Table<ToPhantom<ID>, ToPhantom<MintAllowance<T0>>>>;
  roles: ToField<Roles<T0>>;
  compatibleVersions: ToField<VecSet<"u64">>;
}

export type TreasuryReified<T0 extends PhantomTypeArgument> = Reified<
  Treasury<T0>,
  TreasuryFields<T0>
>;

export class Treasury<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::Treasury<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  readonly $isPhantom = Treasury.$isPhantom;

  readonly id: ToField<UID>;
  readonly controllers: ToField<Table<"address", ToPhantom<ID>>>;
  readonly mintAllowances: ToField<
    Table<ToPhantom<ID>, ToPhantom<MintAllowance<T0>>>
  >;
  readonly roles: ToField<Roles<T0>>;
  readonly compatibleVersions: ToField<VecSet<"u64">>;

  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: TreasuryFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Treasury.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::Treasury<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): TreasuryReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Treasury.$typeName,
      fullTypeName: composeSuiType(
        Treasury.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::Treasury<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        Treasury.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Treasury.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Treasury.fromBcs(T0, data),
      bcs: Treasury.bcs,
      fromJSONField: (field: any) => Treasury.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Treasury.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Treasury.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Treasury.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Treasury.fetch(client, T0, id),
      new: (fields: TreasuryFields<ToPhantomTypeArgument<T0>>) => {
        return new Treasury([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Treasury<ToPhantomTypeArgument<T0>>>> {
    return phantom(Treasury.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): Treasury<ToPhantomTypeArgument<T0>> {
  ...
  static fromFieldsWithTypes<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Treasury.reified(typeArg).new({
      ...
      roles: decodeFromFieldsWithTypes(
        Roles.reified(typeArg),
        item.fields.roles
      ),
      compatibleVersions: decodeFromFieldsWithTypes(
        VecSet.reified("u64"),
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Treasury<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching Treasury object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isTreasury(res.data.bcs.type)
    ) {
...
export type TreasuryCapKeyReified = Reified<
  TreasuryCapKey,
  TreasuryCapKeyFields
>;
...
export class TreasuryCapKey implements StructClass {
  ...
  static reified(): TreasuryCapKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TreasuryCapKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TreasuryCapKey.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        TreasuryCapKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TreasuryCapKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        TreasuryCapKey.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): TreasuryCapKey {
    ...
    if (!isTreasuryCapKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TreasuryCapKey object`
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): TreasuryCapKey {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isTreasuryCapKey(data.bcs.type)
      ) {
  ...
  static async fetch(client: SuiClient, id: string): Promise<TreasuryCapKey> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching TreasuryCapKey object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isTreasuryCapKey(res.data.bcs.type)
    ) {
...
export interface UnblocklistedFields<T0 extends PhantomTypeArgument> {
  address: ToField<"address">;
}

export type UnblocklistedReified<T0 extends PhantomTypeArgument> = Reified<
  Unblocklisted<T0>,
  UnblocklistedFields<T0>
>;

export class Unblocklisted<T0 extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::Unblocklisted<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: UnblocklistedFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Unblocklisted.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::Unblocklisted<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): UnblocklistedReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Unblocklisted.$typeName,
      fullTypeName: composeSuiType(
        Unblocklisted.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::Unblocklisted<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        Unblocklisted.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Unblocklisted.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Unblocklisted.fromBcs(T0, data),
      bcs: Unblocklisted.bcs,
      fromJSONField: (field: any) => Unblocklisted.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Unblocklisted.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Unblocklisted.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Unblocklisted.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Unblocklisted.fetch(client, T0, id),
      new: (fields: UnblocklistedFields<ToPhantomTypeArgument<T0>>) => {
        return new Unblocklisted([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Unblocklisted<ToPhantomTypeArgument<T0>>>> {
    return phantom(Unblocklisted.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): Unblocklisted<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isUnblocklisted(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Unblocklisted object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Unblocklisted<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching Unblocklisted object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isUnblocklisted(res.data.bcs.type)
    ) {
...
export interface UnpauseFields<T0 extends PhantomTypeArgument> {
  dummyField: ToField<"bool">;
}

export type UnpauseReified<T0 extends PhantomTypeArgument> = Reified<
  Unpause<T0>,
  UnpauseFields<T0>
>;

export class Unpause<T0 extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::treasury::Unpause<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: UnpauseFields<T0>
  ) {
    this.$fullTypeName = composeSuiType(
      Unpause.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::treasury::Unpause<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): UnpauseReified<ToPhantomTypeArgument<T0>> {
    return {
      typeName: Unpause.$typeName,
      fullTypeName: composeSuiType(
        Unpause.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::treasury::Unpause<${PhantomToTypeStr<
        ToPhantomTypeArgument<T0>
      >}>`,
      typeArgs: [extractType(T0)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T0>>
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        Unpause.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Unpause.fromFieldsWithTypes(T0, item),
      fromBcs: (data: Uint8Array) => Unpause.fromBcs(T0, data),
      bcs: Unpause.bcs,
      fromJSONField: (field: any) => Unpause.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) => Unpause.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Unpause.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Unpause.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Unpause.fetch(client, T0, id),
      new: (fields: UnpauseFields<ToPhantomTypeArgument<T0>>) => {
        return new Unpause([extractType(T0)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0
  ): PhantomReified<ToTypeStr<Unpause<ToPhantomTypeArgument<T0>>>> {
    return phantom(Unpause.reified(T0));
  }
  static get p() {
  ...
  static fromFields<T0 extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T0,
    fields: Record<string, any>
  ): Unpause<ToPhantomTypeArgument<T0>> {
  ...
  static fromSuiParsedData<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isUnpause(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Unpause object`
      );
    }
  ...
  static async fetch<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T0,
    id: string
  ): Promise<Unpause<ToPhantomTypeArgument<T0>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching Unpause object at id ${id}: ${res.error.code}`
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isUnpause(res.data.bcs.type)
    ) {
