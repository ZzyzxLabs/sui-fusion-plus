  ...
  implements StructClass
{
  ...
  static reified<WriteCap extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      ) as `${typeof PKG_V34}::config::Config<${PhantomToTypeStr<
        ToPhantomTypeArgument<WriteCap>
      >}>`,
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Setting.$typeName,
        ...[extractType(Value)]
      ) as `${typeof PKG_V34}::config::Setting<${ToTypeStr<
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        SettingData.$typeName,
        ...[extractType(Value)]
      ) as `${typeof PKG_V34}::config::SettingData<${ToTypeStr<
        ToTypeArgument<Value>
      >}>`,
      typeArgs: [extractType(Value)] as [ToTypeStr<ToTypeArgument<Value>>],
