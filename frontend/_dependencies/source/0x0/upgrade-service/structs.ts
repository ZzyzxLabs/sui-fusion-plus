  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        AdminRole.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AdminRole.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        AdminRole.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AdminRole.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        AdminRole.fetch(client, T, id),
...
export class AuthorizeUpgrade<T extends PhantomTypeArgument>
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: AuthorizeUpgradeFields<T>
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        AuthorizeUpgrade.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AuthorizeUpgrade.fromFieldsWithTypes(T, item),
      ...
      fromJSON: (json: Record<string, any>) =>
        AuthorizeUpgrade.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        AuthorizeUpgrade.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AuthorizeUpgrade.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        AuthorizeUpgrade.fetch(client, T, id),
...
export class CommitUpgrade<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        CommitUpgrade.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        CommitUpgrade.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        CommitUpgrade.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        CommitUpgrade.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        CommitUpgrade.fetch(client, T, id),
...
export class UpgradeCapDeposited<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: UpgradeCapDepositedFields<T>
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        UpgradeCapDeposited.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        UpgradeCapDeposited.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        UpgradeCapDeposited.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeCapDeposited.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeCapDeposited.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeCapDeposited.fetch(client, T, id),
...
export class UpgradeCapExtracted<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: UpgradeCapExtractedFields<T>
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        UpgradeCapExtracted.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        UpgradeCapExtracted.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        UpgradeCapExtracted.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeCapExtracted.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeCapExtracted.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeCapExtracted.fetch(client, T, id),
...
export class UpgradeService<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        UpgradeService.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        UpgradeService.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeService.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeService.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeService.fetch(client, T, id),
...
export type UpgradeServiceDestroyedReified<T extends PhantomTypeArgument> =
  Reified<UpgradeServiceDestroyed<T>, UpgradeServiceDestroyedFields<T>>;

export class UpgradeServiceDestroyed<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: UpgradeServiceDestroyedFields<T>
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        UpgradeServiceDestroyed.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        UpgradeServiceDestroyed.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        UpgradeServiceDestroyed.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        UpgradeServiceDestroyed.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        UpgradeServiceDestroyed.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        UpgradeServiceDestroyed.fetch(client, T, id),
      new: (
        fields: UpgradeServiceDestroyedFields<ToPhantomTypeArgument<T>>
      ) => {
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<UpgradeServiceDestroyed<ToPhantomTypeArgument<T>>>
  > {
