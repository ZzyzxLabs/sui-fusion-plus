...
export class RoleTransferStarted<T extends PhantomTypeArgument>
  implements StructClass
{
  ...
  private constructor(
    ...
    fields: RoleTransferStartedFields<T>
  ) {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        RoleTransferStarted.fromFields(T, fields),
...
export class RoleTransferred<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: RoleTransferredFields<T>
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        RoleTransferred.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RoleTransferred.fromFieldsWithTypes(T, item),
      ...
      fromJSON: (json: Record<string, any>) =>
        RoleTransferred.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        RoleTransferred.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        RoleTransferred.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        RoleTransferred.fetch(client, T, id),
...
export class TwoStepRole<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        TwoStepRole.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TwoStepRole.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        TwoStepRole.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TwoStepRole.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        TwoStepRole.fetch(client, T, id),
