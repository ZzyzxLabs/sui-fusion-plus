import {../../../../_framework/reified
  PhantomReified,../../../../_framework/util
  PhantomToTypeStr,
  PhantomTypeArgument,
  Reified,
  StructClass,
...
export class BlocklisterChanged<T extends PhantomTypeArgument>
  implements StructClass
{
  ...
  private constructor(
    ...
    fields: BlocklisterChangedFields<T>
  ) {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        BlocklisterChanged.fromFields(T, fields),
...
export class MasterMinterChanged<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: MasterMinterChangedFields<T>
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        MasterMinterChanged.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        MasterMinterChanged.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        MasterMinterChanged.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MasterMinterChanged.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MasterMinterChanged.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        MasterMinterChanged.fetch(client, T, id),
  ...
  static get bcs() {
    return bcs.struct("MasterMinterChanged", {
      old_master_minter: bcs
        .bytes(32)
        .transform({
          input: (val: string) => fromHEX(val),
          output: (val: Uint8Array) => toHEX(val),
        }),
      new_master_minter: bcs
        .bytes(32)
        .transform({
          input: (val: string) => fromHEX(val),
          output: (val: Uint8Array) => toHEX(val),
...
export type MetadataUpdaterChangedReified<T extends PhantomTypeArgument> =
  Reified<MetadataUpdaterChanged<T>, MetadataUpdaterChangedFields<T>>;

export class MetadataUpdaterChanged<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: MetadataUpdaterChangedFields<T>
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        MetadataUpdaterChanged.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        MetadataUpdaterChanged.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        MetadataUpdaterChanged.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MetadataUpdaterChanged.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        MetadataUpdaterChanged.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        MetadataUpdaterChanged.fetch(client, T, id),
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<MetadataUpdaterChanged<ToPhantomTypeArgument<T>>>
  > {
  ...
  static get bcs() {
    return bcs.struct("MetadataUpdaterChanged", {
      old_metadata_updater: bcs
        .bytes(32)
        .transform({
          input: (val: string) => fromHEX(val),
          output: (val: Uint8Array) => toHEX(val),
        }),
      new_metadata_updater: bcs
        .bytes(32)
        .transform({
          input: (val: string) => fromHEX(val),
          output: (val: Uint8Array) => toHEX(val),
...
export class OwnerRole<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        OwnerRole.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        OwnerRole.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        OwnerRole.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        OwnerRole.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        OwnerRole.fetch(client, T, id),
...
export class PauserChanged<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        PauserChanged.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PauserChanged.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        PauserChanged.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        PauserChanged.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        PauserChanged.fetch(client, T, id),
...
export type RolesReified<T extends PhantomTypeArgument> = Reified<
  Roles<T>,
  RolesFields<T>
>;
...
export class Roles<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Roles.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Roles.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Roles.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        Roles.fetch(client, T, id),
