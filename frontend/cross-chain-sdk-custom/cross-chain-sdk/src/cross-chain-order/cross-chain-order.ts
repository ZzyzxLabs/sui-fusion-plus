...
export class CrossChainOrder {
    ...
    public static getAdvancedOrderTypedData(): any[] {
        return [
            {name: 'maker_evm', type: 'string'},
            {name: 'maker_sui', type: 'string'},
            {name: 'maker_asset_advanced', type: 'string'},
            {name: 'taker_asset_advanced', type: 'string'},
        ]
    }

    public getAdvancedOrderTypedData(): any[] {
        return [
            {name: 'maker_evm', type: 'string'},
            {name: 'maker_sui', type: 'string'},
            {name: 'maker_asset_advanced', type: 'string'},
